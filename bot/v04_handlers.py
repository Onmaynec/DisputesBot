...
в которых участвовал сам запрашивающий пользователь. Рейтинговая лига вычисляется из
уже сохранённых Elo и числа матчей и не создаёт отдельную запись пользователя.
