...
async def start_v04_command(message: Message) -> None:
    await message.answer(
        ...
        "Новые команды:\n"
        "/pvp_records — личная книга матчевых PvP-рекордов\n"
        "/season_records — публичные рекорды текущего или архивного сезона\n\n"
...
исчезает из карьеры, recap, сравнений, личных и сезонных книг рекордов, архивов и Hall
of Fame. Жалобы сохраняются как аудиторские записи, но связь с удалённым заявителем
очищается."""
