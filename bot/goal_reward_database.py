...
class PvPGoalRewardClaimRow(Base):
    __tablename__ = "pvp_goal_reward_claims"
...
Index(
    ...
    PvPGoalRewardClaimRow.user_id,
    PvPGoalRewardClaimRow.season,
    PvPGoalRewardClaimRow.claimed_at,
)
