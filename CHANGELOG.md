...
- Active-goal limits are enforced transactionally per user and season, including reactivation of completed metrics.
...
- Existing v0.17 record books, v0.16 insights, v0.15 archives and v0.14 rewards remain compatible.
